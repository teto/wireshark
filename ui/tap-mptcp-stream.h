...
#ifndef __TAP_MPTCP_STREAM_H__
#define __TAP_MPTCP_STREAM_H__
...
/** Fill in the segment list for a MPTCP graph
 *
 * @param cf Capture file to scan
 * @param tg MPTCP graph. A valid stream must be set. If either the source or
