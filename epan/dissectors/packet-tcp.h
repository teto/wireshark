...
struct mptcp_analysis {
	...
	/* List of subflows, mptcp_flowgroup_t (tracks tcp stream id or tcp_analisys ?) */
	GSList* subflows;
...
//	struct mptcp_analysis* mptcp_analysis; /* used only when mptcp enabled */
