...
static int hf_mptcp_data_ack = -1;
            ...
            */
            if (mph->mh_dss_flags & MPTCP_DSS_FLAG_DATA_ACK_PRESENT) {
                ...
                if(mptcp_convert_dsn(mph->mh_rawack, tcpd->rev->mptcp_subflow->meta,
                    ...
                    item = proto_tree_add_uint64(mptcp_tree, hf_mptcp_data_ack, tvb, 0, 0, dack64);
                        if (tcp_relative_seq) {
...
proto_register_tcp(void)
{
    ...
    static hf_register_info hf[] = {
        ...
        { &hf_tcp_option_mptcp_address_id,
          { "Address ID", "tcp.options.mptcp.addrid", FT_UINT16,
    ...
    static hf_register_info mptcp_hf[] = {
        ...
        { &hf_mptcp_data_ack,
          { "Multipath TCP Data ACK", "mptcp.dataack", FT_UINT64,
            BASE_DEC, NULL, 0x0, NULL, HFILL}},
